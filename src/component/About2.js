          ...
          <div className="row d-flex align-items-center justify-content-between mb-4">
            ...
            <div className="col-lg-6 pe-lg-5">
              ...
              <h1 className={styles.headingmain}>
                Our Mission
                <span className=""> Reliable </span> HRepairs, Anytime, Anywhere
              </h1>
              <div>
                <h4>
                ...
                <p>
                  At Work Man to Go, our mission is simple: to take the hassle out
                  of finding the right tradesperson. We’re committed to
